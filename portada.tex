...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        Detección de anomalías en servicio de TV-over-IP mediante autoencoder LSTM} \\[1.5cm]

        % Autor
        {\fontfamily{phv}\fontsize{20pt}{25pt}\selectfont
        Ing. Christopher Charaf} \\[1cm]
        ...
        \textbf{Director:} Esp. Ing. María Fabiana Cid (FIUBA)} \\[1cm]

        % Jurados
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        \textbf{Jurados:}} \\[0.5cm]
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Esp. Ing. Cecilia Azul Villanueva (FIUBA)} \\ 
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        Ing. Yessika Arrieta (CIISA)} \\ 
        {\fontfamily{phv}\fontsize{11pt}{15pt}\selectfont
        M.Sc. Niels Pacheco-Barrios (Harvard Medical School)} \\[2cm]
