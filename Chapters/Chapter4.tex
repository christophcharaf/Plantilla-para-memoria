...
La figura~\ref{fig:ciclo-vida-alerta} resume la máquina de estados implementada; la tabla~\ref{tab:deduplicacion} contrasta ambos comportamientos sobre un episodio sostenido.
