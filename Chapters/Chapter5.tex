...
En conjunto, el trabajo demostró que un autoencoder LSTM acoplado al stack de observabilidad ya adoptado en la organización constituye una alternativa viable y auditable frente a umbrales fijos, siempre que el preprocesamiento, la calibración del umbral y la gestión de alertas se diseñen en conjunto con el equipo de operaciones.
