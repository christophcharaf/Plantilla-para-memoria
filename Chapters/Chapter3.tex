...
Las etapas \emph{Encoder LSTM} y \emph{Decoder LSTM} implementan el esquema codificador--bottleneck--decodificador de Malhotra et al. en el módulo \texttt{LSTMAutoencoder}, adaptado al vector de once variables y a la ventana de 20 pasos.
