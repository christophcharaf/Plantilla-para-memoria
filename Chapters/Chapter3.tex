...
\begin{figure}[h]
\centering
\includegraphics[width=0.92\textwidth]{./Figures/infra_demo.png}
\caption{Estructura lógica de ventanas deslizantes.}
...
Esta sección describe el servicio de inferencia en contenedor, la gestión de alertas hacia Opsgenie, los enlaces contextuales a Grafana y el despliegue en los entornos de simulacion y productivo.
